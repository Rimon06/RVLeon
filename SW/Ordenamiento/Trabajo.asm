...
.data
	.align 2
	 ...
	 #int arreglo[11] = 
	arreglo: .word 3 10 1 8 15 5 12 6 5 4 9
	MensajeMain: 	# para imprimir en el main
		.asciiz	"\n\nArreglo ordenado \n\n"
	Mensaje1:
		.asciiz "Elemento "
	Mensaje2:
